...
## Если во время практики стало тревожнее

Так бывает, и это не значит, что медитация вам не подходит. Когда внимание перестаёт цепляться за дела и уходит внутрь, вы впервые за день замечаете, насколько сжато тело и как частит сердце. Ощущение усиливается просто потому, что вы его наконец разглядели.

Что помогает в этот момент:

- открыть глаза и оставить их открытыми: контакт с комнатой возвращает ощущение безопасности;
- сесть, если вы лежали, — сидя тревога переносится легче;
- перевести внимание на что-то внешнее и очень простое: звук за окном, стопы на полу, предметы вокруг;
- сократить практику до трёх-пяти минут и повторять чаще, вместо того чтобы дотерпеть длинную запись.

Если тревога поднимается каждый раз и практика превращается в испытание, начните со звукового фона без слов: он не уводит внимание так глубоко и переносится мягче.

## Дыхание, когда записи под рукой нет

Главное из этих медитаций помещается в одно упражнение, и сделать его можно где угодно — в метро, в коридоре перед разговором, в машине на парковке.

Сядьте или встаньте устойчиво. Вдох через нос на счёт четыре, выдох через чуть сжатые губы на счёт шесть или восемь. Важен именно длинный выдох: на выдохе сердечный ритм слегка замедляется, и тело получает понятный сигнал, что бежать никуда не нужно. Восемь-десять таких циклов обычно хватает, чтобы плечи опустились и дыхание перестало быть поверхностным.

Если считать трудно, положите ладонь на живот и следите, чтобы под рукой было движение. При тревоге дыхание уходит вверх, в грудь, и становится коротким; одно только возвращение его в живот уже меняет состояние. Это же упражнение хорошо делать перед тем, как включить запись, — тогда практика начинается не с нуля.

## Когда нужен специалист

Медитация отлично снимает ситуативное напряжение, но если тревога стала постоянным фоном — держится неделями, мешает спать, работать, есть, общаться, сопровождается приступами с сердцебиением и нехваткой воздуха — это уже не про «нервишки», а возможный повод для работы со специалистом. Тревожные расстройства хорошо поддаются терапии, и обратиться за помощью — разумный шаг, который обычно экономит месяцы.

...
Тревожному уму перед сном нужен мягкий образ, в который можно соскользнуть вместо потока мыслей.

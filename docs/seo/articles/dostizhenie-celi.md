...
Когда ко мне на консультацию приходит человек со словами «я хочу научиться доходить до целей», я почти всегда слышу не одну историю, а две. Первая — про то, что он много раз начинал и бросал: курсы, проекты, спорт, новую работу. Вторая — про ощущение, что «другие как-то умеют», а он сам всё время оказывается в той же точке, что и год назад. И вот эта вторая история — она в первую очередь про самооценку, и планированием её не закрыть.
...
::: pullquote
У меня в работе с клиентами есть простое правило: если у цели нет действия на эту неделю, она ещё не запущена и живёт только на бумаге.
:::
...
Во-вторых, уменьшить шаг. Если не получается заниматься 40 минут — пробуйте 10. Если 10 много — 3. Дело не в слабоволии: мозгу важна регулярность контакта с целью, а громкость усилия для него вторична. Большая доля людей с расплывчатой целью «начать заниматься спортом» бросают её через 2–3 недели — потому что в цель не зашит конкретный маленький шаг сегодня. Зашит — значит, шанс дойти растёт.
...
::: pullquote
Главный навык здесь — умение возвращаться к цели после того, как вы уже один раз с неё ушли. Падения и пересборки случаются у всех, и они не отменяют движение.
:::
...
Доходить до целей помогает устройство самой цели и жизни вокруг неё, а сила воли тут решает мало. Первая работа — отделить чужие «надо» от своего: у своей цели есть конкретное состояние, ради которого вы идёте, и посильный масштаб, на котором накапливается опыт «я могу». Методы разложены по четырём группам — постановка, декомпозиция, поддержание темпа и работа с сопротивлением, — и брать их стоит в связке, потому что один метод весь путь не закрывает. Рабочая сборка состоит из трёх частей: формулировка отвечает «куда я иду», шаги — «как именно», опора — «что меня держит, когда становится тяжело»; третью чаще всего и пропускают. Система живёт на четырёх уровнях — год, квартал, неделя, день, — и самый пропускаемый из них квартальный, хотя именно он позволяет вовремя снять или переписать цель. Сам процесс проходит пять этапов: прояснение, планирование, движение, пересборка, завершение, и застревают обычно между движением и пересборкой. Когда хочется бросить, помогает уменьшить шаг, отличить «не хочу вообще» от «не хочу прямо сейчас» и иметь точку возврата; устойчивая апатия и нарушенный сон — это уже про состояние, и там нужен специалист.

...
| Внутренняя мотивация через смысл | Когда «надо», но не «хочется» | Упражнение Виктора Франкла: «Зачем мне это нужно» в три уровня вглубь |
...
Во-вторых, уменьшить шаг. Если не получается заниматься 40 минут — пробуйте 10. Если 10 много — 3. Это не про слабоволие, это про то, что для мозга важна сама регулярность контакта с целью, а не громкость усилия. Около 70% людей с расплывчатой целью «начать заниматься спортом» бросают через 3 недели — потому что в цель не зашит конкретный маленький шаг сегодня. Зашит — значит, шанс дойти растёт.

...
Арт-терапия — направление, в котором клиент сам создаёт материал: рисует, лепит, режет коллаж, работает с песком, а дальше вместе с терапевтом разбирается, что в этом отозвалось. Термин ввёл Адриан Хилл в 1942 году, а два крыла метода задали Маргарет Наумбург, для которой рисунок был материалом для интерпретации, и Эдит Крамер, у которой целебен сам процесс создания формы. Механизм складывается из трёх процессов: экстернализация выносит внутреннее наружу и даёт увидеть его со стороны, сопротивление материала проявляет собственные паттерны, моторика и дыхание подключают телесный канал. Терапией творчество становится при трёх условиях — альянс, рамка сессии и рефлексия процесса; без них остаётся просто полезное творчество. В статье разобраны четыре формата работы терапевта и основные техники: свободный и тематический рисунок, глина, коллаж, маски, мандала, отдельно — песочная терапия как родственное направление. От работы с метафорическими картами арт-терапию отличает то, кто создаёт изображение: здесь его делает клиент, там оно готовое. Доказательная база у метода скромная и разнородная, клиническая практика — устойчивая, поэтому арт-терапия хорошо работает там, где речи недостаточно, и не годится как первая линия при острых состояниях.

...
Домашняя работа с МАК — это расширенное ведение дневника: карта даёт визуальный повод остановиться, посмотреть на состояние через образ и десять минут писать. Хорошо ложатся три формата: ежедневная короткая рефлексия по трём вопросам, раз в квартал ряд «откуда иду — где я сейчас — куда хочу» и разбор непонятного состояния прямо сейчас. Границы честные: серьёзную травму, важные жизненные решения и самодиагностику в одиночку через карты разбирать не стоит — в решении вы, скорее всего, просто подтвердите себе то, к чему уже склонялись. Для дома удобнее цифровая колода: барьер ниже, а регулярность в этой практике важнее торжественного ритуала. Начинать проще с недели на описание карты, потом добавить мостик к сегодняшнему дню, а дальше смотреть, меняется ли что-то в отношении к собственному дню. Самая частая ошибка — ждать от карты ответа: старик на берегу ничего вам не советует, интересно только то, что вы в нём увидели. И если сниженное настроение, тревога или последствия травматичного опыта держатся неделями, это повод записаться к специалисту.

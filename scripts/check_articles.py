...
# помечается в frontmatter строкой `pillar: true`. Верхняя граница высокая
# намеренно — справочные материалы про МАК и про цели писались отдельным
# ТЗ и живут в диапазоне 2000–4000 слов.
WORDS_PILLAR = (1600, 4300)
